...
<body>
  <div class="container">
   ...
   <form action="contact.php" method="POST">
        <div class="input-box">
          <input type="text" name="name" placeholder="Enter your name" id="t1" required>
        </div>
        <div class="input-box">
          <input type="text" name="email" placeholder="Enter your email" id="t2" required>
        </div>
        <div class="input-box message-box">
          <input type="text" name="feedback" placeholder="Enter your message" required>
          <textarea></textarea>
